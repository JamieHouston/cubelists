...
angular.service('cubesApp', function($route, $location, $window) {
  ...
  $route.when('/system/:parentKey', {template: 'partials/config.html', controller: ListController});
  $route.when('/lists', {template: 'partials/config.html', controller: ListController});
